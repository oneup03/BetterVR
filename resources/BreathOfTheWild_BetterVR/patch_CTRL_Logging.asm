...
;; compare r3 with "Weapon_L"
;lwz r3, 0x00(r5)
;lis r4, str_WeaponL@ha
;addi r4, r4, str_WeaponL@l
;bl _compareString
;beq replaceAndLog
...
lis r5, str_WeaponR_SafeStringStart@ha
addi r5, r5, str_WeaponR_SafeStringStart@l
mr r30, r5
